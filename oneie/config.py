...
class Config(object):
    def __init__(self, **kwargs):
        ...
        # bert
        self.bert_model_name = kwargs.pop(
        ...
        self.symmetric_relations = set(
            kwargs.pop('symmetric_relations', ['PER-SOC']))
        # files
