    ...
    with open(input_path, 'r', encoding='utf-8') as r, \
        ...
        for line in r:
            ...
            for sentence in doc['sentences']:
                ...
                w.write(json.dumps(sent_obj,ensure_ascii=False) + '\n')
...
def split_data(input_file: str,
    ...
    with open(input_file, 'r', encoding='utf-8') as r, \
        open(os.path.join(output_dir, 'train.oneie.json'), 'w',encoding='utf-8') as w_train, \
        open(os.path.join(output_dir, 'dev.oneie.json'), 'w',encoding='utf-8') as w_dev, \
        open(os.path.join(output_dir, 'test.oneie.json'), 'w',encoding='utf-8') as w_test:
        for line in r:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input',default='F:/dataset/ace_2005_td_v7/ace_2005_td_v7/data', help='Path to the input folder')
    parser.add_argument('-o', '--output',default='../data/ace_cn', help='Path to the output folder')
    parser.add_argument('-s', '--split', default='../resource/splits/ACE05-CN',
    ...
    parser.add_argument('-l', '--lang', default='chinese',
